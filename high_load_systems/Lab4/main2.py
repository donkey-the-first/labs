...
# Відключення Primary-ноди
print("Simulating Primary node failure...")
time.sleep(2)  # Дайте трохи часу потокам розпочати роботу
# Цей код припускає, що відключення Primary виконується поза цим скриптом (наприклад, зупинка контейнера Docker)
